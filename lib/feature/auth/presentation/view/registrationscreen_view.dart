...
class _RegisterViewState extends State<RegistrationscreenView> {
  ...
  final _fnameController = TextEditingController(text: "Roshan");
  final _lnameController = TextEditingController(text: "Baidar");
  final _phoneController = TextEditingController(text: "9844634646");
  final _addressController = TextEditingController(text: "Banepa");
